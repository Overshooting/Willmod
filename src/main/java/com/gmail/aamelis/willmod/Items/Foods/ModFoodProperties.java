...
public class ModFoodProperties {
    ...
    public static final FoodProperties KMSAUCE = new FoodProperties.Builder().nutrition(3).saturationModifier(0.25f).alwaysEdible().usingConvertsTo(Items.GLASS_BOTTLE).build();
