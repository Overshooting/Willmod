...
public class KMDBottlerMenu extends AbstractContainerMenu {
    ...
    public KMDBottlerMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public KMDBottlerMenu(int containerId, Inventory inv, BlockEntity entity) {
        super(MenuTypesInit.KMD_BOTTLER_MENU.get(), containerId);

        blockEntity = ((KMDBottlerBlockEntity) entity);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, BlocksInit.KMD_BOTTLER_BLOCK.get());
    }
