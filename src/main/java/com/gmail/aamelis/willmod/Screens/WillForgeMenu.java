package com.gmail.aamelis.willmod.Screens;
...
public class WillForgeMenu extends AbstractContainerMenu {
    ...
    public final WillForgeBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public WillForgeMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public WillForgeMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData newData) {
        super(MenuTypesInit.WILL_FORGE_MENU.get(), containerId);

        blockEntity = ((WillForgeBlockEntity) entity);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, BlocksInit.WILL_FORGE_BLOCK.get());
    }
